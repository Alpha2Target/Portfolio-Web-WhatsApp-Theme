...
function setLastSeen() {
    ...
    lastSeen.innerText = "last seen today at " + date.getHours() + ":" + formatMinutes(date.getMinutes());
}
...
function sendMsg() {
    ...
    dateLabel.innerText = date.getHours() + ":" + formatMinutes(date.getMinutes());
...
function waitAndResponse(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Lakshya Soni</a>.</span><br><br>I am an Information Technology student at <span class='bold'> IIIT Bhopal 👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'start'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "start":
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing B.Tech degree in Information Technology.<br><br>I can comfortably write code in following languages :<br><span class='bold'>C<br>C++<br>Python<br>HTML<br>CSS<br>JavaScript</span><br><br>I've experiance with following frameworks :<span class='bold'><br>TailWind<br>ReactJs</span><br><span class='bold'></span>");
            break;

        case "education":
            sendTextMessage("I am currently pusuing B.Tech degree in Information Technology from IIIT Bhopal <br>Passing Year : 2027<br><br>I have completed my 12th board from CBSE <br>Passing Year:2023<br>Result:87.2%<br><br>I have completed my 10th board from CBSE.<br>Passing Year:2021<br>Result: 90.6%<br>");
            break;
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https://www.instagram.com/lakshyaa__43/'><span class='bold'>Lakshya Soni</a> with ❤️</span>");
            break;
        case "contact":
            sendTextMessage(contactString);
            break;
        case "projects":
            sendTextMessage("You want to check my projects? Then just jump into my Github Account.<br><br><div class='social'><a target='_blank' href='https://github.com/Alpha2Target'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a></div>");
            break;
        default:
            setTimeout(() => {
                sendTextMessage("Hey I couldn't catch you...😢<br>Send 'start' to know more about usage.");
            }, 2000);
            break;
    }
}
